                        ...
                        <form action="{{ route('store_room') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="capacity" name="capacity" placeholder="Enter Room Capacity">
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo_path_1" name="photo_path_1">
                                    <label class="custom-file-label" for="photo_path_1">Upload Photo 1</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo_path_2" name="photo_path_2">
                                    <label class="custom-file-label" for="photo_path_2">Upload Photo 2</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo_path_3" name="photo_path_3">
                                    <label class="custom-file-label" for="photo_path_3">Upload Photo 3</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="photo_path_4" name="photo_path_4">
